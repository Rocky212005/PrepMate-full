...
const RoleInfoHeader = ({role,topicToFocus,experience,description,questions,lastUpdated}) => {
  return <div className='bg-white relative'>
    <div className='container mx-auto px-10 md:px-0'>
        <div className='h-[200px] flex flex-col justify-center relative z-10'>
            ...
            <div className='flex items-center gap-3 mt-4'>
                <div className='text-[10px] font-semibold text-white bg-black px-3 py-1 rounded-full'>
                    Experincec:{experience} {experience==1 ? "Year":"Years"}

                </div>
                <div className='text-[10px] font-semibold text-white bg-black px-3 py-1 rounded-full '>
                    {questions} Q&A
                </div>
                <div className='text-[10px] font-semibold text-white bg-black px-3 py-1 rounded-full'>LastUpdate: {lastUpdated}
        ...
        <div className='w-[40vw] md:w-[30vw] h-[200px] flex items-center justify-center bg-white overflow-hidden absolute top-0 right-0'>
            ...
            <div className='w-16 h-16 bg-fuchsia-400 blur-[45px] animate-blob4'/>
        </div>
    </div>
  </div>
}
