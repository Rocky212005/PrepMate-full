...
const SkeletonLoader = () => {
  return (
   ...
   <div  role='status' className='animate-pulse space-y-4 max-w-3xl'>
      ...
      <div class='space-y-2'>
        <div class='h-3 bg-gray-300 rounded dark:bg-gray-700 w-full'></div>
        <div class='h-3 bg-gray-300 rounded dark:bg-gray-700 w-11/12'></div>
        <div class='h-3 bg-gray-300 rounded dark:bg-gray-700 w-10/12'></div>
        <div class='h-3 bg-gray-300 rounded dark:bg-gray-700 w-9/12'></div>
      </div>
